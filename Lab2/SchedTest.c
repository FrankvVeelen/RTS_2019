...
#define TstSweep
  ...
  RegisterTask (0, 1024, 350, BlinkYellow, YELLOWBLINKPRIO, 0);  // Prio 0 period = 1k, exec time = 350
  RegisterTask (0, 512, 140, BlinkGreen, GREENBLINKPRIO, 0); // prio 1
  RegisterTask (0, 256, 30, BlinkRed, REDBLINKPRIO, 0);   // prio 2
#endif
